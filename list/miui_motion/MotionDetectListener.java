...
public abstract interface MotionDetectListener extends MotionDetectStrategy
{
  ...
  public abstract boolean onMove(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4);

  public abstract void onMoveCancel(View paramView, int paramInt1, int paramInt2);

  public abstract void onMoveFinish(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4, VelocityTracker paramVelocityTracker);
 ...
 * Qualified Name:     com.android.deskclock.widget.MotionDetectListener
